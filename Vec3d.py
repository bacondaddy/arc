...
class Vec3d(object):
    ...
    def dot(self, other):
        return round(float(self.x*other[0] + self.y*other[1] + self.z*other[2]), 3)
...
if __name__ == "__main__":
    ...
    class UnitTestVec3d(unittest.TestCase):
        ...
        def testReverseMath(self):
            ...
            self.assertTrue([111,222,333] ** Vec3d(2,3,2) == [12321, 10941048, 110889])
        ...
        def testAngles(self):            
            v = Vec3d(0, 3, -3)
            self.assertEqual(v.angle_around_y, 180)
            self.assertEqual(v.angle_around_x, -45)
            self.assertEqual(v.angle_around_z, 90)
            ...
            self.assertEqual(v2.angle_around_z, 0)
        ...
        def testHighLevel(self):
            ...
            basis2 = Vec3d(0, 0, 3)
            v = Vec3d(10, 1, 6)
            self.assertTrue(v.convert_to_basis(basis0, basis1, basis2) == [2, 2, 2])
        ...
        def testInplace(self):
            ...
            self.assertEqual(inplace_vec.__round__(), alternate.__round__())
